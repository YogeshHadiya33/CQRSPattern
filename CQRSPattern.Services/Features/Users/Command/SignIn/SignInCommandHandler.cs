...
public class SignInCommandHandler : ICommandHandler<SignInCommand, ICommandResult>
{
    ...
    public SignInCommandHandler(SignInManager<User> signInManager, ICommandResultFactory commandResultFactory, IIdentityTokenService identityTokenService, UserManager<User> userManager, ICustomMapper<UserModel> userMapper)
    {
