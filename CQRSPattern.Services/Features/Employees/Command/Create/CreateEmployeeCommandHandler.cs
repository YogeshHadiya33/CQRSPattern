...
public class CreateEmployeeCommandHandler : ICommandHandler<CreateEmployeeCommand, ICommandResult>
{
    ...
    public CreateEmployeeCommandHandler(IEmployeeRepository employeeRepository, ICommandResultFactory commandResultFactory, IEmployeeBuilder employeeBuilder, ICustomMapper<EmployeeModel> customMapper)
    {
